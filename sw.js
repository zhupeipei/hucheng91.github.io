...
var precacheUrls = [];
  ...
  precacheUrls.push('/2016/10/14/web/javascript/mapAndreduce_reduce/');

  precacheUrls.push('/2018/01/28/web/javascript/PWA/frist/');

  precacheUrls.push('/2018/01/28/web/javascript/base/javascript_oop/');

  precacheUrls.push('/2016/10/14/web/javascript/mapAndreduce_map/');

  precacheUrls.push('/2016/10/17/classLoader_classLoaderPrinciple/');

  precacheUrls.push('/2016/10/17/web/jquery/until/until_1/');

  precacheUrls.push('/2016/10/17/web/jquery/ajax/ajax_5/');

  precacheUrls.push('/2017/05/01/fristWebsite/');

  precacheUrls.push('/2016/10/17/web/jquery/ajax/ajax_4/');

  precacheUrls.push('/2016/10/17/web/jquery/ajax/ajax_2/');

  precacheUrls.push('/2016/10/17/web/jquery/ajax/ajax_3/');

  precacheUrls.push('/2016/10/17/web/jquery/ajax/ajax_1/');

  precacheUrls.push('/2017/03/04/web/javascript/easyui/easy1/');

  precacheUrls.push('/2017/12/01/web/javascript/angular/ng_build_enviroment/');

  precacheUrls.push('/2017/12/01/web/javascript/angular/typeerror/');

  precacheUrls.push('/2017/11/30/web/javascript/angular/arrow_function_this_pro/');

  precacheUrls.push('/2017/12/01/web/javascript/angular/ajax_export_blob/');

  precacheUrls.push('/2016/12/20/life/2016summarize/');

  precacheUrls.push('/2016/12/20/life/helloWorld/');

  precacheUrls.push('/2016/12/20/life/friendmariay/');

  precacheUrls.push('/2017/06/04/life/2017/collage_something/');

  precacheUrls.push('/2017/08/01/life/2017/July_something/');

  precacheUrls.push('/2017/04/09/web/java/freemarker_xdocxreport/');

  precacheUrls.push('/2017/03/04/web/javascript/BOM_DOM/');

  precacheUrls.push('/2017/09/17/web/javascript/angular/angular_component_communication/');

  precacheUrls.push('/2017/11/30/web/css/scss-to-css-by-gulp/');

  precacheUrls.push('/2017/12/01/web/javascript/angular/angular-cli-node-sass-bug/');

  precacheUrls.push('/2017/12/01/web/javascript/angular/angular_cli_build/');

  precacheUrls.push('/2017/05/07/web/javascript/oop/');

  precacheUrls.push('/2017/03/27/web/javascript/qianhouduanfenli/');

  precacheUrls.push('/2017/03/27/web/javascript/qianhouduanfenli02/');

  precacheUrls.push('/2017/11/05/web/methodology/ifNested/');

  precacheUrls.push('/2016/07/30/index/');

  precacheUrls.push('/2016/08/19/classLoader_step/');

  precacheUrls.push('/2016/10/12/web/dom/dom/');

  precacheUrls.push('/2016/10/14/web/jquery/core/jquery_4/');

  precacheUrls.push('/2016/10/13/web/jquery/core/jquery_3/');

  precacheUrls.push('/2016/10/13/web/jquery/core/jquery_2/');

  precacheUrls.push('/2016/10/13/web/jquery/core/jquery_1/');

  precacheUrls.push('/2016/08/23/classLoader_rammanager/');

  precacheUrls.push('/2016/08/27/gitUse/');

  precacheUrls.push('/2016/08/27/importanceOfJavascriptBase/');

  precacheUrls.push('/2016/08/19/classFile/');

  precacheUrls.push('/2016/07/30/javacript_closure/');

  precacheUrls.push('/2016/07/29/select_test/');

  precacheUrls.push('/2016/07/27/stackoverflowerror/');

  precacheUrls.push('/2016/07/11/class_create/');

  precacheUrls.push('/2016/07/03/typeTest/');

  precacheUrls.push('/2016/04/26/callBackLearn/');

  precacheUrls.push('/2016/04/20/formData_use/');

  precacheUrls.push('/2016/04/18/simleModalEngine/');

  precacheUrls.push('/2016/04/13/constant/');

toolbox.precache(precacheUrls);
toolbox.options = {"networkTimeoutSeconds":100};
